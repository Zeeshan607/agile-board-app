...
const TaskViewModal=({open, onClose, task, col_name})=>{
    ...
    const taskPriority=()=>{
      ...
      return null;
            ...
            return (
                    <Modal open={open} onClose={onClose} center id={task.id} classNames={{modal:['container-lg','py-4','']}} focusTrapped={false}>
                        ...
                        <div className="row mx-0">
                            <div className="col-6">
                                <h3>Meta</h3>
                            <div className="form-group my-2" onFocus={(e)=>handleInputFocus(e,this)}>
                                    <label htmlFor="title">Title</label>
                                    <input type="text" name="title" id="title" onChange={(e)=>setTitle(e.target.value)} defaultValue={title} className='form-control' />
                                        {textInputFocus?(
                                            <div className="row mx-0 mt-2">
                                                <div className="col-12 text-end ">
                                                    <button className="btn btn-primary me-2" onClick={(e)=>handleTitleUpdate(e)}>Save</button>
                                                    <button className="btn btn-outline-secondary" data-id="title" onClick={(e)=>cencleInputEdit(e,this)}>Cancel</button>
                                                </div>
                                          </div>  
                                        ):''}
                                </div>
                                ...
                                <div className="form-group my-4" onFocus={(e)=>handleInputFocus(e,this)}>
                                    <label htmlFor="due_date">Due Date</label>
                                    <input type="date" name="due_date" id="due_date" onChange={(e)=>setDueDate(e.target.value)} defaultValue={ moment(dueDate).format('YYYY-MM-DD')} className='form-control' />
                                        {ddInputFocus?(
                                            <div className="row mx-0 mt-2">
                                                <div className="col-12 text-end ">
                                                    <button className="btn btn-primary me-2" onClick={(e)=>handleDdUpdate(e)}>Save</button>
                                                    <button className="btn btn-outline-secondary" data-id="due_date" onClick={(e)=>cencleInputEdit(e,this)}>Cancel</button>
                                                </div>
                                          </div>  
                                        ):''}
                                </div>
                                ...
                                <div className="col-12 ps-1">
                                    <div className="row mx-0">
                                        ...
                                        <div className="col-6  text-end">
                                            <button className="btn btn-sm btn-outline-primary">Delete all</button>
                                        </div>
                                    </div>
